...
export default withLayout(MainLayout)(${pageName});`;
...
// Usage: node generatePage.js Login
const pageName = process.argv[2];
const routeName = process.argv[3];
if (!pageName) {
  console.error('Please provide a page name. Usage: node generatePage.js <PageName>');
} else {
  createPage(pageName);
}
